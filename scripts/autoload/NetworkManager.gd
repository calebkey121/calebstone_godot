...
var api_endpoint: String = "https://athens.tailebb1c8.ts.net/calebstone"
func get_new_game_endpoint() -> String:
	return "%s/new_game" % [api_endpoint]
func get_load_game_endpoint(session_id: String) -> String:
	return "%s/game_state/%s" % [api_endpoint, session_id]
func get_all_sessions_endpoint() -> String:
	return "%s/game_state" % [api_endpoint]
func get_card_library_endpoint() -> String:
	return "%s/card_library" % [api_endpoint]
...
func get_action_endpoint(session_id: String) -> String:
	return "%s/action/%s" % [api_endpoint, session_id]
